...
public class BaeLog implements org.apache.thrift.TBase<BaeLog, BaeLog._Fields>, java.io.Serializable, Cloneable {
  ...
  public BaeLog(BaeLog other) {
    if (other.isSetMessages()) {
      List<BaeLogEntry> __this__messages = new ArrayList<BaeLogEntry>();
  ...
  public int compareTo(BaeLog other) {
    ...
    BaeLog typedOther = (BaeLog)other;
