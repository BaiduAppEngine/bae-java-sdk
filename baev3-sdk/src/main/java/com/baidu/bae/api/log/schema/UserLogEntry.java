...
public class UserLogEntry implements org.apache.thrift.TBase<UserLogEntry, UserLogEntry._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(UserLogEntry other) {
    ...
    UserLogEntry typedOther = (UserLogEntry)other;
