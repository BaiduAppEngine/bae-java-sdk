...
public class BaeMemcachedClient implements BaeCache {
	 ...
	 * @param password  密码
	 */
	public BaeMemcachedClient(String cacheId, String memcacheAddr, String user, String password) {
		if (user.getBytes().length > ZcacheConf.PNAME_MAX_LEN || user.getBytes().length > ZcacheConf.TOKEN_MAX_LEN) {
			cacheClient.setErrno(-3);
			cacheClient.setErrMsg("ak or sk length is larger than " + ZcacheConf.PNAME_MAX_LEN + " !!!");
		}
		this.user = user;
	...
	public void setConnectTimeout(int connect_timeout) {
		if (connect_timeout < BaeMemcachedClient.MIN_TIMEOUT || connect_timeout > BaeMemcachedClient.MAX_TIMEOUT) {
			connect_timeout = BaeMemcachedClient.DEFAULT_TIMEOUT;
		}
	...
	public boolean set( String key, Object value, long expiry ) {
		...
		/*if (key == null || key.equals("")) {
			logger.log(Level.WARNING, "set for null key!!!\n");
			return false;
		}
		if (value == null || value.equals("")) {
			logger.log(Level.WARNING,"set for null value!!!\n");
			return false;
		}*/
		long expire = expiry;
		if (expire < 0) {
	...
	public boolean add( String key, Object value, long expiry ) {
		...
		/*if (key == null || key.equals("")) {
			logger.log(Level.WARNING, "add for null key!!!\n");
			return false;
		}
		if (value == null || value.equals("")) {
			logger.log(Level.WARNING,"add for null value!!!\n");
			return false;
		}*/
		if (expiry < 0) {
			expiry = 0;
	...
	public boolean replace( String key, Object value, long expiry ) {
		...
		/*if (key == null || key.equals("")) {
			logger.log(Level.WARNING, "replace for null key!!!\n");
			return false;
		}
		if (value == null || value.equals("")) {
			logger.log(Level.WARNING,"replace for null value!!!\n");
			return false;
		}*/
		if (expiry < 0) {
			expiry = 0;
	...
	public boolean storeCounter( String key, Long counter ) {
		...
		/*if (key == null || key.equals("")) {
			logger.log(Level.WARNING, "store for null key!!!\n");
			return false;
		}
		if (counter == null) {
			logger.log(Level.WARNING, "store for null counter!!!\n");
			return false;
		}*/
